...
func (r *UserRepository) UserRepository() port.UserRepository {
	return &userRepository{
		UserRepository: r,
	}
}
...
func (r *UserRepository) UserProfileRepository() port.UserProfileRepository {
...
func (r *userRepository) Create(ctx context.Context, email *string, username *string, passwordHash string) (*model.User, error) {
...
func (r *userRepository) CheckEmailExists(ctx context.Context, email string) (bool, error) {
	...
	if err != nil {
		return false, common.MapPgError(err)
	}
	return result, nil
}
...
func mapDBUserToModel(row *db.User) *model.User {
	var email *string
	var username *string
